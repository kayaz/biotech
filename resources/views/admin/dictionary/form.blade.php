        ...
        <div class="card-head container">
            <div class="row">
                <div class="col-12 pl-0">
                    <h4 class="page-title"><i class="fe-book-open"></i><a href="{{route('admin.dictionary.index')}}">Przeglądaj słownik</a><span class="d-inline-flex ms-2 me-2">/</span><a href="{{route('admin.dictionary.show', $locale)}}">{{ $available_locales[$locale] }}</a><span class="d-inline-flex ms-2 me-2">/</span>{{ $cardTitle }}</h4>
                </div>
            </div>
        </div>
        <div class="card mt-3">
